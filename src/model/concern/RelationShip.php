...
namespace syx6\model\concern;

use Closure;
use syx6\Collection;
use syx6\db\BaseQuery as Query;
use syx6\db\exception\DbException as Exception;
use syx6\helper\Str;
use syx6\Model;
use syx6\model\Relation;
use syx6\model\relation\BelongsTo;
use syx6\model\relation\BelongsToMany;
use syx6\model\relation\HasMany;
use syx6\model\relation\HasManyThrough;
use syx6\model\relation\HasOne;
use syx6\model\relation\HasOneThrough;
use syx6\model\relation\MorphMany;
use syx6\model\relation\MorphOne;
use syx6\model\relation\MorphTo;
use syx6\model\relation\OneToOne;
...
trait RelationShip
{
    ...
    protected function isRelationAttr(string $attr)
    {
        ...
        if (method_exists($this, $relation) && !method_exists('syx6\Model', $relation)) {
            return $relation;
        }
